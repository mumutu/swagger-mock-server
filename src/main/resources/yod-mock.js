...
/***/ function(module, exports, __webpack_require__) {
	...
	function _checkCreateName(name) {
	  if (type.isNameExists(name)) {
	      print('Type "%s" already exists, you are overwriting it!', name);
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	modifier.create = function(filters, name, fn, ctx) {
	  ...
	  if (modifier.isNameExists(name)) {
	     print('Modifier "' + name + '" already exists, you are overwriting it!');
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	    ...
	    function warn(msg) {
	        if (utils_hooks__hooks.suppressDeprecationWarnings === false && typeof console !== 'undefined' && print) {
